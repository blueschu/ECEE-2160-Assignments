 ...
 *
 * In order to ensure that only one memory mapping is created, this class
 * retains a cached static MemoryMapping object, which is accessible from the
 * member function get_memory_mapping().
 */
